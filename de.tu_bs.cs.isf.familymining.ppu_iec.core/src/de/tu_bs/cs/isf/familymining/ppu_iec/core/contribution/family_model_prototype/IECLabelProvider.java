...
public class IECLabelProvider implements LabelProvider {
	...
	public String getLabel(Object object) {
		...
		if (object instanceof Diagram) {
			...
			return llElement.getTransitElementType().toString() + "(" + llElement.getLabeledVariable().getSymbol()
					+ ", " + llElement.getStatus().toString() + ")";
		}
...
//			} 
		...
		if (object instanceof SequentialFunctionChart) {
			...
			return "Step Action(" + ((SimpleAction) object).getCondition().getName() + ")";
		} else if (object instanceof ComplexAction) {
			return "Step Action(" + ((ComplexAction) object).getPouVariable().getName() + "."
					+ ((ComplexAction) object).getPouAction().getName() + ")";
