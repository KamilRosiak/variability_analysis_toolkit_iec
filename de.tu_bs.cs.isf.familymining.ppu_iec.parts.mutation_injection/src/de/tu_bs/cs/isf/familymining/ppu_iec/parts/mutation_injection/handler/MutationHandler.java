...
public class MutationHandler {
	...
	public void executeMutation(ServiceContainer services, MutationEngine engine) {
		FileTreeElement currentSelection = services.rcpSelectionService.getCurrentSelectionFromExplorer();
		Configuration model = (Configuration) EMFModelLoader.load(currentSelection.getAbsolutePath(), E4CStringTable.FILE_ENDING_CONFIGURATION);
